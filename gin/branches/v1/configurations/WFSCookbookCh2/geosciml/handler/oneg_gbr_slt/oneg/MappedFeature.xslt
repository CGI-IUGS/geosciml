...
<xsl:stylesheet version="1.0" 
	...
	<xsl:template match="ms:GBR_BGS_625k_SLT">
		<gsml:MappedFeature gml:id="{@gml:id}">
			...
			<gsml:specification>
				<gsml:GeologicUnit gml:id="gu.{@gml:id}">
					<gml:description><xsl:value-of select="ms:ROCK_D"/></gml:description>
					<gml:name codeSpace="urn:cgi:classifierScheme:BGS:Lithology:description"><xsl:value-of select="ms:ROCK_D"/></gml:name>
					<gsml:observationMethod>
						<gsml:CGI_TermValue>
