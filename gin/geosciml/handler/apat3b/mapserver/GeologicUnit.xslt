...
<gsml:GeologicUnit gml:id="{esri:cartobase.geo.geology500k.formation_1}">
<gml:name>Geologic Units description</gml:name>
<gml:name codeSpace="urn:ietf:rfc:2141">urn:cgi:feature:APAT:<xsl:value-of select="esri:cartobase.geo.geology500k.formation_1"/></gml:name>
<xsl:variable name="thisUnit" select="esri:cartobase.geo.geology500k.formation_1"/>
<xsl:apply-templates select="//esri:ITA_APATSGI_EN_500k_Geologicformation-ITA_APATSGI_EN_500k_Geologicformation[esri:cartobase.geo.geology500k.formation_1=$thisUnit]" mode="occurrence"/>
<gsml:composition>
...
<xsl:template match="esri:ITA_APATSGI_EN_500k_Geologicformation-ITA_APATSGI_EN_500k_Geologicformation" mode="occurrence">
<gsml:occurrence>
	<gsml:MappedFeature gml:id="{@fid}">
		...
		<gsml:specification xlink:href="{esri:cartobase.geo.geology500k.formation_1}"/>
