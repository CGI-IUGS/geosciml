...
<schema  see="http://www.opengis.net/spec/geosciml/4.1/req/gsml4xsd-lite-31/sch" xmlns="http://purl.oclc.org/dsdl/schematron" 
queryBinding="xslt2" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<!--
        ...
        in the requirements class: http://www.opengis.net/spec/geosciml/4.1/req/gsml4xsd-lite-31/sch
    -->
	...
	<p>This schematron schema checks the GeoSciML-lite XML encoding requirements of OGC GeoSciML 4.1, as specified
        in the requirements class: http://www.opengis.net/spec/geosciml/4.1/req/gsml4xsd-lite-31/sch</p>
